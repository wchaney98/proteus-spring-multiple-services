...
@javax.inject.Named(
    value ="BlockingAnotherHelloServiceServer")
public final class BlockingAnotherHelloServiceServer extends io.rsocket.rpc.AbstractRSocketService {
  private final BlockingAnotherHelloService service;
  ...
  @javax.inject.Inject
  public BlockingAnotherHelloServiceServer(BlockingAnotherHelloService service, java.util.Optional<reactor.core.scheduler.Scheduler> scheduler, java.util.Optional<io.micrometer.core.instrument.MeterRegistry> registry) {
    ...
    if (!registry.isPresent()) {
      ...
      this.anotherSayHello = io.rsocket.rpc.metrics.Metrics.timed(registry.get(), "rsocket.server", "service", BlockingAnotherHelloService.SERVICE_ID, "method", BlockingAnotherHelloService.METHOD_ANOTHER_SAY_HELLO);
    }
  ...
  public String getService() {
    return BlockingAnotherHelloService.SERVICE_ID;
  }
    ...
    try {
      ...
      switch(io.rsocket.rpc.frames.Metadata.getMethod(metadata)) {
        case AnotherHelloService.METHOD_ANOTHER_SAY_HELLO: {
          ...
          io.netifi.proteus.quickstart.anotherservice.protobuf.AnotherHelloRequest message = io.netifi.proteus.quickstart.anotherservice.protobuf.AnotherHelloRequest.parseFrom(is);
          return reactor.core.publisher.Mono.fromSupplier(() -> service.anotherSayHello(message, metadata)).map(serializer).transform(anotherSayHello).subscribeOn(scheduler);
        }
        default: {
